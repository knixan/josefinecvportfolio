...
const SOCIALS = [
  { icon: FaFacebook, label: "Facebook", href: "https://www.facebook.com/profile.php?id=61579831973399" },
  { icon: FaInstagram, label: "Instagram", href: "https://www.instagram.com/kodochdesign/" },
  { icon: FaLinkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/josefine-eriksson-349498345/" },
      ...
      <div className="max-w-screen-xl mx-auto px-6 py-12 lg:py-16">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="text-sm">
                <p className="text-slate-200 font-semibold text-base">Josefine Eriksson</p>
                <p className="text-slate-400 text-xs">{t("footer.fullstackDesigner")}</p>
              </div>
              ...
              <div className="flex items-center space-x-3 text-sm text-slate-300">
                ...
                <a href="mailto:josefineeriksson@live.se" className="hover:text-indigo-400 transition-colors">
            ...
            <div className="grid grid-cols-2 gap-3">
              {SOCIALS.map((social, i) => (
                ...
                >
                  ...
                  <span className="text-slate-300 text-xs font-medium group-hover:text-white transition-colors">{social.label}</span>
                </a>
              ))}
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <p>
            ...
            <span className="text-slate-300 font-medium">Josefine Eriksson Kod & Design</span>
          </p>
