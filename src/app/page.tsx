...
const cvPage = () => {
  return (
    <div className="container max-w-7xl mx-auto mt-16 p-4 flex gap-8 flex-wrap lg:flex-nowrap bg-gray-900 text-gray-200">
      {/* ASIDE */}
      <aside className="left-column flex-none w-full lg:w-1/3 bg-gray-800 rounded-md shadow-md overflow-hidden">
        ...
        {/* Info */}
        <div className="p-4">
          <p className="my-2 text-pink-400">
            <FaBriefcase className="mr-2 inline-block" /> Josefine Eriksson,
            Designer
          </p>
          <p className="my-2 text-pink-400">
          ...
          {/* Färdigheter */}
          <h3 className="mt-4 mb-2 text-xl text-purple-400">Program</h3>
          <div className="flex flex-wrap gap-2 mb-4">
            {programs.map((program, index) => (
              <span
                key={index}
                className="bg-purple-600 text-white text-xs font-semibold px-2.5 py-0.5 rounded-full"
              >
                {program}
              </span>
            ))}
          ...
          {/* Språk */}
          <h3 className="mt-4 mb-2 text-xl text-purple-400">Språk</h3>
          <div className="flex flex-wrap gap-2 mb-4">
          ...
          <h3 className="mt-4 text-xl mb-2 text-purple-400">Körkort</h3>
          <div className="flex flex-wrap gap-2 mb-4">
      ...
      <main className="right-column flex-1 w-full lg:w-2/3">
        ...
        <section className="card bg-gray-800 mb-8 p-8 rounded-md shadow-md">
          ...
          <div className="job-entry mb-6">
            <h5 className="font-bold text-purple-400 text-lg mb-1">
          ...
          <div className="job-entry mb-6">
            <h5 className="font-bold text-purple-400 text-lg mb-1">Säljare</h5>
            <p className="my-1 text-gray-300">
        ...
        <section className="card bg-gray-800 mb-8 p-8 rounded-md shadow-md">
          ...
          <div className="education-entry mb-6">
            ...
            <p className="my-1 text-gray-300">Kristinehamns Folkhögskola</p>
          </div>
          <div className="education-entry mb-6">
            <h5 className="font-bold text-purple-400 text-lg mb-1">
            ...
            <p className="my-1 text-gray-300">Tullängsskolan Örebro</p>
          </div>
        </section>
      </main>
    </div>
